...
/* Assumptions: Bear/Base/Bull tabs */
...
.tab { appearance: none; background: transparent; border: 0; border-bottom: 2px solid transparent;
  color: var(--muted); font: inherit; font-weight: 600; font-size: 15px; padding: 8px 16px;
  cursor: pointer; margin-bottom: -1px; }
.tab:hover { color: var(--text); }
.tab.active { color: var(--text); border-bottom-color: var(--accent); }
.tab-panel { display: none; }
.tab-panel.active { display: block; }
.assump { padding: 16px 0; border-bottom: 1px solid var(--border); }
.assump:last-child { border-bottom: 0; }
.assump-head { display: flex; align-items: center; gap: 10px; flex-wrap: wrap; }
.assump-label { font-weight: 600; }
.assump-val { font-variant-numeric: tabular-nums; font-size: 18px; font-weight: 700; margin-top: 6px; }
.assump .read-note { display: block; margin: 8px 0 0; max-width: 68ch; }
.yr-strip { display: flex; flex-wrap: wrap; gap: 6px; margin-top: 10px; }
.yr { display: flex; flex-direction: column; align-items: center; min-width: 50px;
  padding: 6px 4px; border: 1px solid var(--border); border-radius: 8px; background: var(--panel); }
.yr-n { font-size: 10px; color: var(--muted); text-transform: uppercase; letter-spacing: .04em; }
.yr-v { font-size: 13px; font-weight: 600; font-variant-numeric: tabular-nums; margin-top: 2px; }
